...
def upgrade():
    ...
    op.alter_column("scoresets", "licence_id", existing_type=sa.INTEGER(), nullable=False)
...
def downgrade():
    ...
    op.drop_constraint(None, "scoresets", type_="foreignkey")
    op.alter_column("scoresets", "licence_id", existing_type=sa.INTEGER(), nullable=True)
