...
def test_clinical_classification_of_variant_with_thresholds(
    ...
    classification, strength = zeiberg_calibration_clinical_classification_of_variant(mock_mapped_variant)
...
def test_clinical_classification_of_variant_without_thresholds(mock_mapped_variant):
    ...
    with pytest.raises(ValueError) as exc:
        zeiberg_calibration_clinical_classification_of_variant(mock_mapped_variant)
