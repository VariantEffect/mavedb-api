...
def test_create_wild_type_sequence(test_with_empty_db, sequence_type, sequence):
...
def test_create_invalid_sequence_type(test_with_empty_db, sequence_type, sequence):
...
def test_create_invalid_sequence(test_with_empty_db, sequence_type, sequence):
    with pytest.raises(ValueError) as exc_info:
        WildTypeSequenceCreate(sequence_type=sequence_type, sequence=sequence)
