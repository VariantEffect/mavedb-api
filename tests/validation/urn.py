...
class TestValidateUrn(TestCase):
    ...
    def test_valid_mavedb_urn_score_set(self):
        validate_mavedb_urn_score_set("urn:mavedb:00000001-a-1")

    def test_invalid_mavedb_urn_score_set(self):
        with self.assertRaises(ValidationError):
            validate_mavedb_urn_score_set("")
    ...
    def test_invalid_mavedb_urn_variant(self):
        with self.assertRaises(ValidationError):
            validate_mavedb_urn_variant("urn:mavedb:00000002-a-1")  # this is a score set urn
...
class TestValidateTmpUrn(TestCase):
    ...
    def test_valid_tmp_mavedb_urn_score_set(self):
        validate_mavedb_urn_score_set("tmp:0a56b8eb-8e19-4906-8cc7-d17d884330a5")

    def test_invalid_tmp_mavedb_urn_score_set(self):
        with self.assertRaises(ValidationError):
            validate_mavedb_urn_score_set("")
