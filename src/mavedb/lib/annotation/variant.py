...
def _variation_from_mapped_variant(mapped_variant: MappedVariant) -> Optional[dict]:
...
def mapped_variant_to_variant_effect_measurement_study_result(
...
) -> Optional[AssayVariantEffectMeasurementStudyResult]:
    """
    ...
    return AssayVariantEffectMeasurementStudyResult(
        ...
        focusVariant=MolecularVariation(**variation),
...
def mapped_variant_to_functional_classification_statement(
    ...
    if classification is None or variation is None:
        return None

    return AssayVariantEffectFunctionalClassificationStatement(
        subjectVariant=MolecularVariation(**variation),
...
def annotation_for_variant(mapped_variant: MappedVariant) -> dict[str, AnnotatedVariant]:
    return {
        f"{mapped_variant.variant.urn}": AnnotatedVariant(
