...
from mavedb.lib.identifiers import create_external_gene_identifier_offset, find_or_create_doi_identifier, find_or_create_pubmed_identifier
...
async def upload_scoreset_variant_data(
    ...
    if scores_file:
        try:
            #validate_variant_column_agreement(scores_df, counts_df)
