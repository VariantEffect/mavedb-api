...
class ScoreRange(BaseModel):
    ...
    def range_classification_value_is_accepted(cls, value: str) -> str:
...
class ScoreSetModify(ScoreSetBase):
    ...
    def score_range_labels_must_be_unique(cls, field_value: ScoreRanges) -> ScoreRanges:
        existing_labels = []
    ...
    @field_validator("score_ranges")
    def ranges_contain_normal_and_abnormal(cls, field_value: ScoreRanges) -> ScoreRanges:
