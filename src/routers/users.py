...
from src.lib.authorization import require_current_user, RoleRequirer
from src.models.user import User
from src.view_models import user
...
async def show_user(
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail=f'Multiple users with ID {id} were found.'
        )
    if not item:
        raise HTTPException(
