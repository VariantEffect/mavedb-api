...
from src.lib.validation.constants.general import null_values_list
from src.lib.validation.variant import validate_hgvs_string #validate_pro_variant, validate_nt_variant

from src.lib.validation.utilities import (
    is_null,
    generate_hgvs,
    construct_hgvs_pro,
